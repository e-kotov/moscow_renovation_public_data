...
| last_geojson   | последний geojson файл с актуальными данными по домам включенным в программу по состоянию на февраль 2018 года, все другие данные только по процессу голосования летом 2017. |
